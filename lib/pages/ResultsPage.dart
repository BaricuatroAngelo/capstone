...
//     final url = Uri.parse(
//         'http://10.0.2.2:8000/api/patients/${widget.patientId}/results');
//
//     try {
...
//               'results_data']; // Assuming 'results_data' is the key in the API response that holds the results for the patient.
//         });
//       } else {
...
//               child: Center(
//                 child: Text(
//                   _resultsData.isNotEmpty
//                       ? _resultsData
//                       : 'No results available for patient ${widget.patientId}.',
...
//                     builder: (context) => PostResultsPage(
